...
import '../../../video/presentation/pages/video_feed_screen.dart';
  ...
  decoration: BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(
        ...
        offset: Offset(0, 4), // Shadow below the logo
        blurRadius: 8,
      ),
    ],
  ),
  child: ClipRRect(
    borderRadius: BorderRadius.circular(12), // Ensures the image is also rounded
    child: Image.asset(
      'assets/images/logo.png',
      width: 40,
      height: 40,
      fit: BoxFit.contain, // Maintains the aspect ratio without distortion
    ),
  ),
)
